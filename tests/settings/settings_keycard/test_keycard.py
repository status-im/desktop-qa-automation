...
pytestmark = allure.suite("Keycard")
...
def test_create_keycard_account_with_new_seed_phrase(main_screen: MainWindow):
    ...
    with (step('Verify displayed keycard popup instructions are correct')):
        ...
        with step('Verify image is correct'):
            keycard_image = keycard_popup.keycard_image
            image.compare(keycard_image, 'keycard_image_plugin_reader.png')
